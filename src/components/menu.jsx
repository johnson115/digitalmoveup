...
const cafeFroid = [
  ...
  { name: "Moka Glacé", price: "4.99", image: "/placeholder.svg?height=100&width=100" },
  ...
  { name: "Latte Glacé", price: "3.99", image: "/placeholder.svg?height=100&width=100" },
  { name: "Chocolat Belge", price: "1.99", image: "/placeholder.svg?height=100&width=100" },
  { name: "Frappé Croquant", price: "3.99", image: "/placeholder.svg?height=100&width=100" },
  { name: "Milk-shake au Chocolat", price: "4.99", image: "/placeholder.svg?height=100&width=100" }
];

const desserts = [
  { name: "Gâteau au Fromage", price: "1.99", image: "/placeholder.svg?height=100&width=100" },
  { name: "Fantaisie au Chocolat", price: "2.99", image: "/placeholder.svg?height=100&width=100" },
  { name: "Brownie", price: "4.99", image: "/placeholder.svg?height=100&width=100" },
  { name: "Fudge au Chocolat", price: "1.99", image: "/placeholder.svg?height=100&width=100" },
  { name: "Boule de Glace à la Vanille", price: "3.99", image: "/placeholder.svg?height=100&width=100" },
  { name: "Gâteau au Fromage aux Baies", price: "1.99", image: "/placeholder.svg?height=100&width=100" },
  { name: "Gâteau à la Fraise", price: "3.99", image: "/placeholder.svg?height=100&width=100" },
  { name: "Gâteau Red Velvet", price: "4.99", image: "/placeholder.svg?height=100&width=100" }
];
...
const MenuItem = ({ name, price, image }) => (
  <div className="flex items-center mb-4">
    <div className="relative">
      ...
      <span className="absolute top-0 right-0 bg-orange-300 text-white rounded-full px-2 py-1 text-xs">
        ${price}
      </span>
    </div>
    <div className="ml-4">
      <h3 className="text-lg text-black font-semibold">{name}</h3>
      <p className="text-sm text-gray-600">Sit lorem ipsum et diam elitr est dolor sed duo guberg sea et et lorem dolor</p>
    </div>
  </div>
);
...
export default function CoffeeMenu() {
  return (
    <div className="container mx-auto px-4 py-8 bg-orange-50">
      <h1 className="text-center text-3xl font-bold mb-2 text-orange-800">MENU & PRICING</h1>
      <h2 className="text-center text-4xl font-bold mb-8 text-orange-900">Competitive Pricing</h2>
      <div className="flex flex-wrap -mx-4">
        <MenuSection title="Café Chaud" items={cafeChaud} />
        <MenuSection title="Collations" items={collations} />
        <MenuSection title="Café Froid" items={cafeFroid} />
